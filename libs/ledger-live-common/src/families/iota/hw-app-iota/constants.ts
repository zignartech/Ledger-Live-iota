...
export class DataTypeEnum {
    ...
    get_type(i: number): DataTypeEnum {
        switch(i) {
            case(0): return DataTypeEnum.Empty;
            case(1): return DataTypeEnum.GeneratedAddress;
            case(2): return DataTypeEnum.ValidatedEssence;
            case(3): return DataTypeEnum.UserConfirmedEssence;
            case(4): return DataTypeEnum.Signatures;
            case(5): return DataTypeEnum.Locked;
            default: return DataTypeEnum.Unknown;
        }
    };
}